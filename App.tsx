...
const App: React.FC = () => {
  ...
  const placeOrder = (orderDetails: OrderDetails) => {
    ...
    const itemsText = cart.map(i => `• ${i.name} (${i.weight}) x ${i.quantity} = ₹${i.price * i.quantity}`).join('\n');
    
    const message = `नमस्ते 😊
Rakesh Kirana Store में आपका स्वागत है।
मैं अभी ऑनलाइन हूँ, आप अपना ऑर्डर बता सकते हैं।
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-gray-50">
      ...
      <div className="fixed bottom-6 right-6 flex flex-col gap-3 z-40">
        ...
        <a 
          href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent('नमस्ते 😊 Rakesh Kirana Store में आपका स्वागत है।')}`}
          target="_blank"
